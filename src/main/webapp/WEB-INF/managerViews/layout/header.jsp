...
<body>
	<nav
		...
		<a href="main.do" class="navbar-brand d-flex d-lg-none me-4">
			...
			<i class="fa fa-hashtag">EATGO</i>
			</h2>
		</a> <a href="#" class="sidebar-toggler flex-shrink-0"> 
		<i class="fa fa-bars"></i>
		</a>
		<c:if test="${not empty loginManager.loginId}">
		<div class="navbar-nav align-items-center ms-auto">
			<div class="nav-item dropdown">
				<a href="#" class="nav-link dropdown-toggle"
					...
					class="d-none d-lg-inline-flex">${loginManager.loginId}</span>
				</a>
				<div
					class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
					<a href="managerInfo.do" class="dropdown-item">내 정보 보기</a> 
